    ...
    <div>
      {!expanded ? (
        <button
          ...
          className="w-full flex items-center justify-between px-4 py-3 rounded-2xl bg-brand-card border border-brand-border hover:border-slate-600 transition-all text-left group"
        >
          ...
          <span className="flex items-center gap-1.5 text-[10px] font-semibold text-brand-gold group-hover:text-amber-300 transition-colors">
            Show
            <ChevronDown size={12} />
          </span>
        </button>
